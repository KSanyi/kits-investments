...
public class PositionTest {
    ...
    void updateTest() {
        ...
        position = position.update(new TradeOrder(LocalDate.parse("2020-09-01"), AAPL, 2, new BigDecimal(300)));
    ...
    void aggregateTest() {
        Position position = Position.aggregate(AAPL, List.of(
                new TradeOrder(LocalDate.parse("2020-09-01"), AAPL,  2, new BigDecimal(300)),
                new TradeOrder(LocalDate.parse("2020-09-02"), AAPL,  3, new BigDecimal(310)),
                new TradeOrder(LocalDate.parse("2020-09-03"), AAPL, -4, new BigDecimal(290)),
                new TradeOrder(LocalDate.parse("2020-09-04"), AAPL,  1, new BigDecimal(300))));
